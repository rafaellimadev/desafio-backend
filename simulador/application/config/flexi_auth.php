...
*/
	...
	*/ 
	...
	$config['database']['user_acc']['columns']['codindicacao'] = 'uacc_cod_indicacao';
	$config['database']['user_acc']['columns']['indicador_id'] = 'uacc_indicador_id';
	$config['database']['user_acc']['columns']['bloco_id'] = 'uacc_bloco_id';
	$config['database']['user_acc']['columns']['adesao_paga'] = 'uacc_adesao_paga';
	$config['database']['user_acc']['columns']['cadastro_completo'] = 'uacc_cadastro_completo';
 ...
 */
$config['database']['custom']['user_profiles']['table'] = 'user_profiles';
$config['database']['custom']['user_profiles']['primary_key'] = 'upro_id';
$config['database']['custom']['user_profiles']['foreign_key'] = 'upro_uacc_id';
$config['database']['custom']['user_profiles']['join'] = 'user_profiles.upro_uacc_id';
$config['database']['custom']['user_profiles']['custom_columns'] = array(
    'nmCompleto',
	'nrDocumento',
	'imgPerfil',
    'sexo',
...
###+++++++++++++++++++++++++++###
	...
	*/
	$config['security']['login_session_expire'] = 600000;
	...
	*/
	...
	$config['messages']['delimiters']['error_prefix'] = '<div class="alert alert-danger">';
