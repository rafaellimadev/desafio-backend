...
$lang['min_length']			= "O campo %s deve ter pelo menos %s caracter(es).";
$lang['max_length']			= "O campo %s não pode exceder %s caracter(es).";
$lang['exact_length']		= "O campo %s deve ter exatamente %s caracter(es).";
...
$lang['file_required']		= "É obrigatório informar um arquivo no campo %s";
