...
class CI_Email {
	...
	var	$smtp_host		= "smtp.kinghost.net";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "doopy@doopy.com.br";		// SMTP Username
	var	$smtp_pass		= "juka1420";		// SMTP Password
