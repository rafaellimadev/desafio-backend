CREATE DATABASE  IF NOT EXISTS `marketplace` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `marketplace`;
...
CREATE TABLE `transaction` (
  ...
  `credit_card` varchar(300) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-08-07 18:46:47
CREATE DATABASE  IF NOT EXISTS `marketplace_log` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `marketplace_log`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: marketplace_log
-- ------------------------------------------------------
-- Server version	5.5.5-10.3.15-MariaDB
